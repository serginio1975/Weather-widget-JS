...
export async function myLocation(latitude, longitude) {
  await fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${latitude}&lon=${longitude}&appid=79e9565b6d45f0a48a3ff121a711792c`
  )
 ...
 console.log("myLocation in API_request:" , myLocation( 49.9444087, 36.2906715));
